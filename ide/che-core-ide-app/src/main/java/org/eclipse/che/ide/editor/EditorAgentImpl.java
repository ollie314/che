...
public class EditorAgentImpl implements EditorAgent,
    ...
    public void onFileOperation(FileEvent event) {
        switch (event.getOperationType()) {
            case OPEN:
                ...
                break;
            case CLOSE:
                Log.error(getClass(), "onFileOperation -> closeEditor(EditorPartPresenter editor)");
    ...
    public void closeEditor(EditorTab tab) {
        ...
        closeEditor(tab.getRelativeEditorPart());
    }
    ...
    public void closeEditor(EditorPartPresenter editor) {
        Log.error(getClass(), "closeEditor(EditorPartPresenter editor)");
        if (editor == null) {
            return;
        }
